...
<head>
  ...
  <style>
    nav {
      box-shadow: 0 10px 10px #8c8c8c1f;
    }
...
<body class="hold-transition layout-top-nav sidebar-mini sidebar-collapse layout-navbar-fixed">
  <div class="wrapper">

    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand-md navbar-dark fixed border-bottom-0" style="
            background-color: rgb(30,40,113);
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" style=" background-color: rgb(30,40,113);">
      <!-- Brand Logo -->
